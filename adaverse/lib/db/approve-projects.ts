...
async function approveProjects() {
    ...
    try {
        console.log('📂 Reading approved projects SQL file...');
        const sqlContent = readFileSync(sqlFilePath, "utf-8");

        if (!sqlContent.trim()) {
            console.log('ℹ️  No approved projects to process');
            return;
        }
        ...
        if (sqlBlocks.length === 0) {
            console.log('ℹ️  No valid SQL blocks found in the approved projects file');
            return;
        }
        ...
        console.log('✅ All approved projects have been added to the database!');
        ...
        console.log('🧹 Cleared the approved projects file');

    } catch (error) {
        if ((error as NodeJS.ErrnoException).code === 'ENOENT') {
            console.log('ℹ️  No approved projects file found. Creating one...');
            writeFileSync(sqlFilePath, '-- Approved projects will be added here\n-- This file is auto-generated by the approval system\n\n');
        } else {
